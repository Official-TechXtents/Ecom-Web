...
const Login = () => {
  ...
  return (
    ...
    <form className=' flex flex-col item-center w-[90%] sm:max-w-96 m-auto mt-14 gap-4 text-gray-800'>
      ...
      {currentState==='Login'?'':<input type="text" className=' w-full px-3 py-2 border border-gray-800' placeholder='First Name' />}
      ...
      <div className="w-full flex justify-between text-sm mt-[-8px]">
        ...
        {
          currentState==='Login'
    ?<p className=' cursor-pointer' onClick={()=>setCurrentState('Sign Up')}>Create New Account</p>
